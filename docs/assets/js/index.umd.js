...
(function (global, factory) {
  ...
  var updateUrlQuery = function updateUrlQuery() {
    ...
    return stringifyUrl(
      baseUrl,
      _objectSpread2(_objectSpread2({}, query), params)
    );
  };
  /**
   * 跳转页面
  ...
  var linkTo = function linkTo() {
    ...
    var computedOptions = _objectSpread2(
  ...
  var getWordWidth = function getWordWidth() {
    ...
    eleSpan.style.cssText = getCssText(
      _objectSpread2(_objectSpread2({}, defaultCssom), cssom)
    );
  ...
  var convertDataToCascader = function convertDataToCascader(res, config) {
    var _config$path = config.path,
      ...
      childrenKey =
        _config$childrenKey === void 0 ? "children" : _config$childrenKey,
  ...
  var b64toBlob = function b64toBlob(b64Data) {
    var contentType =
      arguments.length > 1 && arguments[1] !== undefined
        ...
        : "image/jpeg";
    var sliceSize =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 512;
  ...
  var getPercentageHtml = function getPercentageHtml(value) {
    ...
    if (value > 0) {
      ...
      return '<span style="color: '
        .concat(reverse ? redColor : greenColor, ';">')
        .concat(tempValue, "</span>");
    }
    ...
    if (value < 0) {
      ...
      return '<span style="color: '
        .concat(reverse ? greenColor : redColor, ';">')
        .concat(tempValue, "</span>");
    }
  ...
  _defineProperty(ValidatorRules, "numberRangeMessageFunc", function (
    description,
    value
  ) {
