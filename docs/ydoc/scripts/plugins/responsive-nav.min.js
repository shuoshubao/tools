      ...
      (v.prototype = {
        ...
        open: function () {
          l ||
            (r(g, 'closed'),
            q(g, 'opened'),
            q(u, h.navActiveClass),
            q(i, 'active'),
            (g.style.position = h.openPos),
            p(g, { 'aria-hidden': 'false' }),
            (l = !0),
            h.open())
        },
        close: function () {
        ...
        resize: function () {
          'none' !== b.getComputedStyle(i, null).getPropertyValue('display')
            ? ((k = !0),
              p(i, { 'aria-hidden': 'false' }),
              g.className.match(/(^|\s)closed(\s|$)/) &&
                (p(g, { 'aria-hidden': 'true' }), (g.style.position = 'absolute')),
              this._createStyles(),
              this._calcHeight())
            : ((k = !1),
        ...
        _preventDefault: function (a) {
          return a.preventDefault
            ? (a.stopImmediatePropagation && a.stopImmediatePropagation(), a.preventDefault(), a.stopPropagation(), !1)
        ...
        _onTouchMove: function (a) {
          ;(Math.abs(a.touches[0].clientX - this.startX) > 10 || Math.abs(a.touches[0].clientY - this.startY) > 10) &&
