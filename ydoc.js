  ...
  pluginsConfig: {
    'import-asset': {
      css: [
        ...
        isDevelopment
          ? 'http://127.0.0.1:9999/assets/css/site.css'
          : 'https://shuoshubao.github.io/tools/assets/css/site.css',
      ...
      js: [
        ...
        isDevelopment
          ? 'http://127.0.0.1:9999/assets/js/code.js'
          : 'https://shuoshubao.github.io/tools/assets/js/code.js'
      ]
    }
  }
}
