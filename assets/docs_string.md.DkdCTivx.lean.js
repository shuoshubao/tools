...
};`,ctx:{type:"declaration",name:"getTooltipHtml",value:"(...args) => {",string:"getTooltipHtml"}}],d=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/string.md","filePath":"documents/string.md","lastUpdated":null}'),o={name:"docs/string.md"},f=Object.assign(o,{setup(p){const e=n(i);return(c,m)=>{const t=a("Dox");return s(),l("div",null,[r(t,{data:e.value},null,8,["data"])])}}});export{d as __pageData,f as default};
