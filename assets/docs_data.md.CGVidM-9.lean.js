...
};`,ctx:{type:"declaration",name:"formatEmptyToDefault",value:"(data = {}, formater = {}) => {",string:"formatEmptyToDefault"}}],f=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/data.md","filePath":"documents/data.md","lastUpdated":null}'),p={name:"docs/data.md"},y=Object.assign(p,{setup(i){const e=t(o);return(c,d)=>{const a=r("Dox");return s(),n("div",null,[l(a,{data:e.value},null,8,["data"])])}}});export{f as __pageData,y as default};
