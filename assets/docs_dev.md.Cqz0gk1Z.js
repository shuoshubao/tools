import{s as t,D as n,c as a,I as l,o}from"./chunks/framework.0k0VOrm2.js";const i=[{tags:[{type:"param",string:"{Number} [time] 等待时长(秒)",name:"[time]",description:"<p>等待时长(秒)</p>",types:["Number"],typesDescription:"<code>Number</code>",optional:!0,nullable:!1,nonNullable:!1,variable:!1},{type:"example",string:`
await sleep()
console.log('hi')
