...
};`,ctx:{type:"declaration",name:"getImageSize",value:"(url = '', attrs = {}) => {",string:"getImageSize"}}],m=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/image.md","filePath":"vitepress-docs/image.md","lastUpdated":null}'),r={name:"docs/image.md"},u=Object.assign(r,{setup(c){const e=a(o);return(p,g)=>{const t=s("Dox");return l(),n("div",null,[i(t,{data:e.value},null,8,["data"])])}}});export{m as __pageData,u as default};
