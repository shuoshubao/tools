import{s as l,D as t,c as s,I as n,o as r}from"./chunks/framework.0k0VOrm2.js";const p=[{tags:[{type:"param",string:"{...Number} [args] 加数",name:"[args]",description:"<p>加数</p>",types:["Number"],typesDescription:"...<code>Number</code>",optional:!0,nullable:!1,nonNullable:!1,variable:!0},{type:"return",string:"{Number} 运算之和",types:["Number"],typesDescription:"<code>Number</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1,description:"<p>运算之和</p>"},{type:"example",string:`
plus(0.1, 0.2)
...
};`,ctx:{type:"declaration",name:"divide",value:"(a, b) => {",string:"divide"}}],d=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/decimal.md","filePath":"docs/decimal.md","lastUpdated":null}'),i={name:"docs/decimal.md"},b=Object.assign(i,{setup(o){const e=l(p);return(u,c)=>{const a=t("Dox");return r(),s("div",null,[n(a,{data:e.value},null,8,["data"])])}}});export{d as __pageData,b as default};
