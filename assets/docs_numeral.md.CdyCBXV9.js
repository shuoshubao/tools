import{s as a,D as t,c as l,I as s,o as r}from"./chunks/framework.0k0VOrm2.js";const o=[{tags:[{type:"param",string:"{Number} num 数值",name:"num",description:"<p>数值</p>",types:["Number"],typesDescription:"<code>Number</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1},{type:"return",string:"{String}     千分位字符串",types:["String"],typesDescription:"<code>String</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1,description:"<p>千分位字符串</p>"},{type:"example",string:`
thousands(123);
...
// =&gt; 7</p>`}],description:{full:"<p>取区间值</p>",summary:"<p>取区间值</p>",body:""},isPrivate:!1,isConstructor:!1,isClass:!1,isEvent:!1,ignore:!1,line:33,codeStart:53,code:`const getValueInRange = (value, min, max) => {
    ...
    return value;
};`,ctx:{type:"declaration",name:"getValueInRange",value:"(value, min, max) => {",string:"getValueInRange"}}],d=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/numeral.md","filePath":"docs/numeral.md","lastUpdated":null}'),p={name:"docs/numeral.md"},f=Object.assign(p,{setup(i){const e=a(o);return(u,m)=>{const n=t("Dox");return r(),l("div",null,[s(n,{data:e.value},null,8,["data"])])}}});export{d as __pageData,f as default};
