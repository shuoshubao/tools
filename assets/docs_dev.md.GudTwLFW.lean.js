...
};`,ctx:{type:"declaration",name:"sleep",value:"(...args) => {",string:"sleep"}}],g=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/dev.md","filePath":"vitepress-docs/dev.md","lastUpdated":null}'),r={name:"docs/dev.md"},u=Object.assign(r,{setup(p){const e=t(i);return(m,c)=>{const s=a("Dox");return o(),n("div",null,[l(s,{data:e.value},null,8,["data"])])}}});export{g as __pageData,u as default};
