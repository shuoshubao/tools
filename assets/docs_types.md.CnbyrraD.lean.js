...
};`,ctx:{type:"declaration",name:"isSomeFalsy",value:"(...args) => {",string:"isSomeFalsy"}}],f=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/types.md","filePath":"documents/types.md","lastUpdated":null}'),p={name:"docs/types.md"},m=Object.assign(p,{setup(o){const e=s(i);return(y,u)=>{const t=l("Dox");return r(),a("div",null,[n(t,{data:e.value},null,8,["data"])])}}});export{f as __pageData,m as default};
