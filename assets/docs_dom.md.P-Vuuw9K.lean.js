import{s as t,D as a,c as n,I as l,o}from"./chunks/framework.0k0VOrm2.js";const i=[{tags:[],description:{full:"<p>eslint-disable no-use-before-define</p>",summary:"<p>eslint-disable no-use-before-define</p>",body:""},isPrivate:!1,isConstructor:!1,isClass:!1,isEvent:!1,ignore:!1,line:1,codeStart:3,code:`import { isNumber, kebabCase, last, uniq } from 'lodash';
...
};`,ctx:{type:"declaration",name:"suffixClassNames",value:"(baseClassName = '', suffixConfig = {}, config = {}) => {",string:"suffixClassNames"}}],f=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/dom.md","filePath":"docs/dom.md","lastUpdated":null}'),r={name:"docs/dom.md"},b=Object.assign(r,{setup(p){const e=t(i);return(c,d)=>{const s=a("Dox");return o(),n("div",null,[l(s,{data:e.value},null,8,["data"])])}}});export{f as __pageData,b as default};
