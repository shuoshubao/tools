import{s as r,D as a,c as t,I as l,o as b}from"./chunks/framework.0k0VOrm2.js";const s=[{tags:[{type:"type",string:"{Array.<ValidatorRules>}",types:["Array.<ValidatorRules>"],typesDescription:"<code>Array</code>.<<code>ValidatorRules</code>>",optional:!1,nullable:!1,nonNullable:!1,variable:!1,html:"<p>{Array.<ValidatorRules>}</p>"},{type:"example",string:`
