...
// =&gt; 7</p>`}],description:{full:"<p>取区间值</p>",summary:"<p>取区间值</p>",body:""},isPrivate:!1,isConstructor:!1,isClass:!1,isEvent:!1,ignore:!1,line:33,codeStart:53,code:`const getValueInRange = (value, min, max) => {
    ...
    return value;
};`,ctx:{type:"declaration",name:"getValueInRange",value:"(value, min, max) => {",string:"getValueInRange"}}],d=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/numeral.md","filePath":"vitepress-docs/numeral.md","lastUpdated":null}'),p={name:"docs/numeral.md"},f=Object.assign(p,{setup(i){const e=a(o);return(u,m)=>{const n=t("Dox");return r(),s("div",null,[l(n,{data:e.value},null,8,["data"])])}}});export{d as __pageData,f as default};
