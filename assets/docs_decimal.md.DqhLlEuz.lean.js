...
};`,ctx:{type:"declaration",name:"divide",value:"(a, b) => {",string:"divide"}}],d=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/decimal.md","filePath":"vitepress-docs/decimal.md","lastUpdated":null}'),i={name:"docs/decimal.md"},b=Object.assign(i,{setup(o){const e=l(p);return(u,c)=>{const a=t("Dox");return r(),s("div",null,[n(a,{data:e.value},null,8,["data"])])}}});export{d as __pageData,b as default};
