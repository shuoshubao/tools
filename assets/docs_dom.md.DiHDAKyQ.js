...
};`,ctx:{type:"declaration",name:"suffixClassNames",value:"(baseClassName = '', suffixConfig = {}, config = {}) => {",string:"suffixClassNames"}}],f=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/dom.md","filePath":"documents/dom.md","lastUpdated":null}'),r={name:"docs/dom.md"},b=Object.assign(r,{setup(p){const e=t(i);return(c,d)=>{const s=a("Dox");return o(),n("div",null,[l(s,{data:e.value},null,8,["data"])])}}});export{f as __pageData,b as default};
