...
memoizedAdd(1, 2) // 3</p>`}],description:{full:"<p>memoize/cache</p>",summary:"<p>memoize/cache</p>",body:""},isPrivate:!1,isConstructor:!1,isClass:!1,isEvent:!1,ignore:!1,line:3,codeStart:18,code:`const memoize = fn => {
    ...
    return memoized;
};`,ctx:{type:"declaration",name:"memoize",value:"fn => {",string:"memoize"}}],u=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/memoize.md","filePath":"docs/memoize.md","lastUpdated":null}'),d={name:"docs/memoize.md"},f=Object.assign(d,{setup(m){const e=a(c);return(r,l)=>{const n=t("Dox");return i(),o("div",null,[s(n,{data:e.value},null,8,["data"])])}}});export{u as __pageData,f as default};
