...
};`,ctx:{type:"declaration",name:"formatTime",value:"(date, format = 'YYYY-MM-DD', invalidText = '--') => {",string:"formatTime"}}],f=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/date.md","filePath":"documents/date.md","lastUpdated":null}'),p={name:"docs/date.md"},g=Object.assign(p,{setup(l){const e=a(i);return(m,d)=>{const t=n("Dox");return o(),r("div",null,[s(t,{data:e.value},null,8,["data"])])}}});export{f as __pageData,g as default};
