import{s as a,D as t,c as s,I as o,o as i}from"./chunks/framework.0k0VOrm2.js";const c=[{tags:[{type:"param",string:"{Function} fn     缓存的函数",name:"fn",description:"<p>缓存的函数</p>",types:["Function"],typesDescription:"<code>Function</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1},{type:"return",string:"{Function}        包装的函数",types:["Function"],typesDescription:"<code>Function</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1,description:"<p>包装的函数</p>"},{type:"example",string:`
const add = (a, b) => {
  return a + b;
}
