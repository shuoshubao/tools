import{e as a,ah as n,c as s,U as i,o}from"./chunks/framework.DI3RqUrd.js";const l=[{tags:[{type:"param",string:"{String} url 图片的url",name:"url",description:"<p>图片的url</p>",types:["String"],typesDescription:"<code>String</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1},{type:"return",string:"{Object}     图片的尺寸 { width, height }",types:["Object"],typesDescription:"<code>Object</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1,description:"<p>图片的尺寸 { width, height }</p>"},{type:"example",string:`
(async() => {
...
};`,ctx:{type:"declaration",name:"getImageSize",value:"(url = '') => {",string:"getImageSize"}}],d=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"docs/image.md","filePath":"docs/image.md","lastUpdated":null}'),r={name:"docs/image.md"},h=Object.assign(r,{setup(c){const e=a(l);return(g,p)=>{const t=n("Dox");return o(),s("div",null,[i(t,{data:e.value},null,8,["data"])])}}});export{d as __pageData,h as default};
