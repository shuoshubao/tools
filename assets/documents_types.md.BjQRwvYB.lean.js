import{e as s,ah as l,c as a,U as n,o as r}from"./chunks/framework.DI3RqUrd.js";const i=[{tags:[{type:"param",string:"{*} value    值",name:"value",description:"<p>值</p>",types:"[object Object]",typesDescription:"*",optional:!1,nullable:!1,nonNullable:!1,variable:!1},{type:"return",string:"{String}     构造函数名",types:["String"],typesDescription:"<code>String</code>",optional:!1,nullable:!1,nonNullable:!1,variable:!1,description:"<p>构造函数名</p>"},{type:"example",string:`
getType()
...
};`,ctx:{type:"declaration",name:"isSomeFalsy",value:"(...args) => {",string:"isSomeFalsy"}}],f=JSON.parse('{"title":"","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"documents/types.md","filePath":"documents/types.md","lastUpdated":null}'),p={name:"documents/types.md"},m=Object.assign(p,{setup(o){const e=s(i);return(y,u)=>{const t=l("Dox");return r(),a("div",null,[n(t,{data:e.value},null,8,["data"])])}}});export{f as __pageData,m as default};
